(function (factory) {
    ...
    var getChildren = function (parentPath, ignoreMDFiles) {
        ...
        // return (0, sortBy_1.default)(files, ['path']).map(function (file) {
           

        //     return (file === null || file === void 0 ? void 0 : file.path) || '';
        // });
    ...
    function side(baseDir, baseUrl, options) {
     ...
     */
    var getSideBar = function (rootDir, baseUrl, options) {
        if (rootDir === void 0) { rootDir = './'; }
        return side(rootDir, baseUrl, options);
    };
